                ...
                <div class="absolute h-[250px] w-full max-w-[250px] overflow-hidden top-0 right-0">
                    <div class="relative w-full h-[100%]">
                        ...
                        <div class="absolute top-[5%] left-[0%] animate-float">
                            <img src="./assets/images/Desktop - Quiz selection/Deco haut droite/P-2.png" alt="Polygone 1"
                                class="hidden lg:block">
                        </div>
                        <!-- Polygone 2 -->
                        <div class="absolute top-[5%] left-[68%] animate-float2">
                            <img src="./assets/images/Desktop - Quiz selection/Deco haut droite/P-3.png" alt="Polygone 2"
                                class="hidden lg:block">
                        </div>
                        <!-- Polygone 3 -->
                        <div class="absolute top-[25%] left-[0%] animate-float2">
                            <img src="./assets/images/Desktop - Quiz selection/Deco haut droite/P-1.png" alt="Polygone 3"
                                class="hidden lg:block">
                        </div>
                        <!-- Polygone 4 -->
                        <div class="absolute top-[35%] left-[55%] animate-float">
                            <img src="./assets/images/Desktop - Quiz selection/Deco haut droite/P-4.png" alt="Polygone 4"
                                class="hidden lg:block">
                        </div>
                        <div class="absolute top-[65%] left-[43%] animate-float2">
                            <img src="./assets/images/Desktop - Quiz selection/Deco haut droite/P-5.png" alt="Polygone 5"
                                class="hidden lg:block">
                        </div>
                    </div>
                </div>
